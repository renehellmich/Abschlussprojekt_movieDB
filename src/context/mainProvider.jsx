    ...
    return (
        <>
            <mainContext.Provider
                value={{ apiKey, apiLink, movieID, setMovieID, detail, setDetail, trailer, setTrailer, backPath, setBackPath, genre, setGenre, searchedOrFilteredMovies, setSearchedOrFilteredMovies, searchInput, setSearchInput }}
            >
                {children}
            </mainContext.Provider>
        </>
